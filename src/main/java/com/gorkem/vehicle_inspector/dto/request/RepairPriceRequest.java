...
public record RepairPriceRequest(
        ...
        @Size(
                max = 100,
                message = "Model en fazla 100 karakter olabilir."
        )
        String model,
        ...
        @Min(
                value = 1950,
                message = "Model yılı 1950'den küçük olamaz."
        )
        @Max(
                value = 2100,
                message = "Model yılı 2100'den büyük olamaz."
        )
        Integer modelYear,
        ...
        @NotNull(message = "Hasar derecesi zorunludur.")
